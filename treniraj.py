...
WORDS = ("_background_noise_snippets_", "desno", "levo", "napred", "nazad", "stoj", "zastani")
...
# Train the model.
model.fit(xs, ys, batch_size=256, validation_split=0.3, shuffle=True, epochs=205)
...
bla = ["_background_noise_"]
bla += WORDS[1:]
metadata = {"words": bla, "frameSize": model.input_shape[-2]}
